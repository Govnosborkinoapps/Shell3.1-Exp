...
namespace ProgramManagerVC
{
    public partial class Shell : Form
    {
        ...
        private void FormMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Программа будет закрыта.", "Подтвердить закрытие?", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        private void InitializeTitle()
        {
            ...
            {
                Text = $"Shell3.1 - {Environment.MachineName}/{Environment.UserName}";
            }
            else
            {
                Text = "Shell3.1";
        ...
        {
            DialogResult result = MessageBox.Show("Программа Будет закрыта.", "Вы Действительно хотите выйти?", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        {
            Form formSettings = new ShellSettings();
